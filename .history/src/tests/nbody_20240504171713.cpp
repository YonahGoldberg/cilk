...
int main() {
    ...
    particles.push_back(Particle(0.0, 0.0, 0.0, 0.0, 1000.0)); // Massive particle at origin
    particles.push_back(Particle(1.0, 0.0, 0.0, 1.0, 1.0));    // Small particle with velocity
