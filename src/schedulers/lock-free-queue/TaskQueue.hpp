...
public:
  ...
  // This thread tries to pop from back of the queue and adds to back of the
  // queue allowing for LF
  ...
  // This thread adds to back of queue to reduce contention and they steal from
  // front
