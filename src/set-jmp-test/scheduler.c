...
static inline void sc_list_init(sc_list_head *list) {
...
static inline void sc_list_insert_end(sc_list_head *head, sc_list_head *new) {
    sc_list_add(new, head->prev, head);
}

static inline void sc_list_remove(sc_list_head *entry) {
...
void scheduler_relinquish(lambda)
{
